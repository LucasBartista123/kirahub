...
local function v271(p58, p59)
	...
	local dir = "Kira/" .. v26(t1.Game)
	if type(makefolder) == "function" then pcall(makefolder, dir) end
	if type(makefolder) == "function" then pcall(makefolder, dir .. "/cache") end
	if type(makefolder) == "function" then pcall(makefolder, dir .. "/configs") end
